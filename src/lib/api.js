...
const googlePhotoLink = (phref) => `https://maps.googleapis.com/maps/api/place/photo?photoreference=${phref}&maxwidth=640&key=AIzaSyDgHLkqOFD4nkK1oX5_Kl3Xx7E0e0jrQJg`


export async function getPlaces(lat,lng) {
    // const response = await fetch("https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${lat},${lng}&radius=500&opennow&types=food&key=AIzaSyDgHLkqOFD4nkK1oX5_Kl3Xx7E0e0jrQJg");
